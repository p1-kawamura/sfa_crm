...
class Hangire(models.Model):
    approach_id=models.CharField("アプローチID",max_length=3)
    ...
    busho_apr_name=models.CharField("連絡部署名",max_length=255,blank=True,null=True)
    tantou_apr_id=models.CharField("連絡担当ID",max_length=255,blank=True,null=True)
    tantou_apr_name=models.CharField("連絡担当名",max_length=255,blank=True,null=True)
    ...
    #approach_id（アプローチID）　0：版切れ　１～：アプローチ　N：納品後　H：半年版切れ　G：版切れ以外受注　L：失注
