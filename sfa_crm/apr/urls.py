...
urlpatterns = [
    ...
    path('hangire_modal_bikou/', hangire_modal_bikou, name="hangire_modal_bikou"),
    path('hangire_modal_ask_gemini/', hangire_modal_ask_gemini, name="hangire_modal_ask_gemini"),
